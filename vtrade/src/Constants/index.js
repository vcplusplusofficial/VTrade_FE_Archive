...
export const selectedCircleSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="#000000">
    <circle cx="10" cy="10" r="9" stroke="#e5e7eb" />
  </svg>
);

export const unselectedCircleSvg = (
