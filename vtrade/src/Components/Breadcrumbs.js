          ...
          {pathnames.map((name, index) => {
            ...
            return (
              <React.Fragment key={name}>
                ...
                {isLast ? (
                  <span className="text-sky-400 capitalize font-mulish text-base font-semibold text-s leading-5">
                    {name}
                  </span>
                ) : (
                  <Link
                    to={routeTo}
                    className="text-gray-600 capitalize font-mulish text-base font-semibold text-s leading-5"
                  >
                    {name}
                  </Link>
                )}
